const BUSINESS_INFO = {
  ...
  address: {
    streetAddress: "730 Peachtree St NE, Ste 570",
  ...
  description:
    "Independent commercial telecommunications contractor — internet installation, business networking, and security systems for commercial clients nationwide.",
};
